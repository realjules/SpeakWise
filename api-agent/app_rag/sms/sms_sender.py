...
class SMSSender:
    ...
    def __init__(self, config: Config):
        ...
        print("PINDO API KEY:",self.api_key)
        self.headers = {
            # "Authorization": f"Bearer {self.api_key}",
            "Authorization": f"Bearer eyJhbGciOiJIUzUxMiIsInR5cCI6IkpXVCJ9.eyJleHAiOjE4Mzc4OTQ5NzQsImlhdCI6MTc0MzIwMDU3NCwiaWQiOiJ1c2VyXzAxSlFFRDBZSFk2OEc2WkVDSkpIN1dFOUpBIiwicmV2b2tlZF90b2tlbl9jb3VudCI6MH0.ejo81tPmq2Qsd1o-REVpq2C2lY5P_HOFsja-TwahZstLEutg93JUR1WOhp5seqBF9OaITHKHt9--srvdM6DtPw",
